...
export const initialMLState = {
  ...
  predictions: {
    Overall: {
      ...
      explanation:
        "High rainfall intensity (42.6 mm/h at AWS-1) combined with elevated soil moisture (78%) and recent slope instability in Zone A increases landslide probability significantly.",
      recommendedActions: [
        "Issue Early Warning to Hill Sector residents & NH-13 traffic control",
        "Monitor AWS-1 soil moisture continuously at 1-minute intervals",
      ...
      inputInfluences: [
        { parameter: "Soil Moisture (AWS-1)", value: "78 %", influence: "High", weight: 92, status: "critical" },
        { parameter: "Rainfall Intensity (AWS-1)", value: "42.6 mm/h", influence: "High", weight: 88, status: "critical" },
        { parameter: "River Water Level (Station Alpha)", value: "1.8 m", influence: "Medium", weight: 64, status: "warning" },
        { parameter: "Air PM2.5 (Station Alpha)", value: "82 µg/m³", influence: "Medium", weight: 58, status: "warning" },
    ...
    Landslide: {
      ...
      explanation:
        "Excessive pore water pressure detected via AWS-1 soil sensors. Slope saturation exceeds 75% stability threshold with continuous rain.",
      recommendedActions: [
        "Close NH-13 Hill Sector section immediately to heavy vehicles",
        "Deploy drone LiDAR to scan Zone A tension cracks",
        "Set AWS-1 telemetry rate to 30-second burst mode",
      ],
      inputInfluences: [
        { parameter: "Soil Moisture (AWS-1)", value: "78 %", influence: "High", weight: 98, status: "critical" },
        { parameter: "Rainfall Intensity (AWS-1)", value: "42.6 mm/h", influence: "High", weight: 94, status: "critical" },
    ...
    Flood: {
      ...
      explanation:
        "Water level at Station Alpha is elevated (1.8m) but river velocity remains within drainage capacity. Downstream surge monitored.",
      recommendedActions: [
      ...
      inputInfluences: [
        { parameter: "Water Level (Station Alpha)", value: "1.8 m", influence: "High", weight: 82, status: "warning" },
    ...
    AirQuality: {
      ...
      inputInfluences: [
        { parameter: "PM2.5 (Station Alpha)", value: "82 µg/m³", influence: "High", weight: 88, status: "warning" },
